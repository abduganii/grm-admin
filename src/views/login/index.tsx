        ...
        <span> Главная </span> | <span>Войти в кабинет</span>  
          ...
          <div className="flex  gap-[92px]">
              <div className='w-full  max-w-[360px]'>
                  ...
                  <p className="text-[#212121] leading-[17px] text-[15px] mb-[31px]">Автоматизация процесса: производство, склад, продажи и контроль процессов для роста вашего бизнеса.</p>
                  ...
                  <button onClick={onClick} className="py-[12px] px-[25px] cursor-pointer bg-[#282828] text-[15px] leading-[18px] text-white"> Войти</button>
            </div>
          </div>
    </Container>
  )
